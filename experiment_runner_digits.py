...
EXPERIMENTS = [
    ...
    {"name": "b=64 mini", "layers": [784,100,10], "lr": 0.0001, "epochs": 250, "epsilon": 1e-6, "beta": 1.0, "initializer": "xavier", "training_mode": "minibatch", "batch_size": 64,   "optimizer": "adam"},
]
...
def run_experiment(config, X_train, y_train, train_labels, X_eval, y_eval, eval_labels):
    print(f"\n--- {config['name']} ---")
...
def main():
    ...
    args = [(c, X_train, y_train, train_labels, X_val, y_val, val_labels)
